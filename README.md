...
✅ 'Мягкое' удаление пользователем своей учетной записи
...
✅ Управление пользователями:
  ...
  DELETE /delete_me/                # 'мягкое' удаление пользователем своей учетной записи
...
- 'Мягкое' удаление пользователем своего аккаунта
